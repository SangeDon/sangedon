...
> **作者：[贾不假](https://juejin.im/post/6850037271233331208)**
...
![MySQL架构图](Mysql知识点总结/1734bff308eb9e2d.png)
...
![查询流程图](Mysql知识点总结/1734bff309fc730f.png)
...
![整形](Mysql知识点总结/1734bff30a28cf0d.png)



![时间类型](Mysql知识点总结/1734bff309f9eea0.png)



![字符串类型](Mysql知识点总结/1734bff30a5e00fe.png)
...
- 可以简单的理解为“排好序的快速查找数据结构”，数据本身之外，**数据库还维护者一个满足特定查找算法的数据结构**，这些数据结构以某种方式引用（指向）数据，这样就可以在这些数据结构上实现高级查找算法。这种数据结构，就是索引。下图是一种可能的索引方式示例。
  ...
  ![索引简图](Mysql知识点总结/1734bff356f9f2f0.png)
...
![B-Tree](Mysql知识点总结/1734bff356b40f0d.png)
...
![B+Tree](Mysql知识点总结/1734bff3498c6715.png)
...
![非聚簇索引](Mysql知识点总结/1734bff35bbbf112.png)
...
![聚簇索引](Mysql知识点总结/1734bff337681c17.png)
...
![辅助索引](Mysql知识点总结/1734bff365f39d10.png)
...
- 总结
  ...
  ![SQL执行顺序](Mysql知识点总结/1734bff368752ece.png)
...
![连接示例图](Mysql知识点总结/1734bff37ac0e7f6.png)
...
![ACID](Mysql知识点总结/1734bff377ece423.png)
...
![分布式事务模型](Mysql知识点总结/1734bff37e532a33.png)
...
![执行计划信息](Mysql知识点总结/1734bff38d5d8333.png)
...
![执行计划示例](Mysql知识点总结/1734bff38f6a6955.png)
...
![示例](Mysql知识点总结/1734bff39882383d.png)
...
![水平/垂直分表](Mysql知识点总结/1734bff39ffffdd1.png)
...
- 三个步骤
  ...
  ![主从复制](Mysql知识点总结/1734bff3c7c7b231.png)
...
**[EnjoyMoving](https://zhuanlan.zhihu.com/p/29150809)**

**[程序员内点事](https://juejin.im/post/6844904061523886088#heading-105)**

**[菜鸟笔记](https://blog.csdn.net/yin767833376/article/details/81511377)**
