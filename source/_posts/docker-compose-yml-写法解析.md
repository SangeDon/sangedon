---
title: docker-compose.yml 写法解析
date: 2020-11-15 21:25:20
tags:
categories:
---

> **Compose 是用于定义和运行多容器 Docker 应用程序的工具。通过 Compose，通过使用 YML 文件来配置应用程序需要的所有服务。然后，使用一个命令，就可以从 YML 文件配置中创建并启动所有服务。**

<!-- more -->

#### 下面是docker-compose.yml 配置文件常用字段解析
